  ...
  const socialLinks = [
    {
      name: "Instagram",
      icon: FaInstagram,
      url: "https://instagram.com/mafiincloud",
      color: "hover:text-pink-600",
    },
    {
      name: "Facebook",
      icon: FaFacebook,
      url: "https://facebook.com/mafiincloud",
      color: "hover:text-blue-700",
    },
    {
      name: "YouTube",
      icon: FaYoutube,
      url: "https://youtube.com/@mafiincloud",
      color: "hover:text-red-600",
    },
    {
      name: "TikTok",
      icon: FaTiktok,
      url: "https://tiktok.com/@mafiincloud",
            ...
            <div className="flex justify-center space-x-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`transform text-2xl text-gray-600 transition-all duration-300 hover:scale-110 dark:text-gray-400 ${social.color}`}
